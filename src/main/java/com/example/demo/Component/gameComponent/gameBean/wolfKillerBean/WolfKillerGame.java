package com.example.demo.Component.gameComponent.gameBean.wolfKillerBean;
...
public class WolfKillerGame extends BasicGame {
     ...
     * @param targetId
     */
    private void werewolvesTrigger(Long userId, Long targetId) {
     ...
     * @return
     */
    private List<WolfKillerGamerData> getOthersSurvivalWerewolves(Long userId) {

...
//            }
//            return joinGame(reqMsg, wolfKillerGameData);
//        }
//
//        wolfKillerGameData = new WolfKillerGame();
//        wolfKillerGameData.setGroupId(reqMsg.getGroup_id());
...
//     * @return
//     */
//    private String joinGame(ReqMsg reqMsg, WolfKillerGame wolfKillerGame) {
...
//        wolfKillerGamerData.setNickName(reqMsg.getSender().getNickname());
//        wolfKillerGamerData.setUserId(userId);
//        String card = reqMsg.getSender().getCard();
//        if (StringUtils.isBlank(card)) {
//            wolfKillerGamerData.setCard(reqMsg.getSender().getNickname());
//        } else {
...
//        WolfKillerGame wolfKillerGame = (WolfKillerGame) gameComponent
//                .getGameData(reqMsg.getGroup_id(), "狼人杀");
//        WolfKillerGamerData gamerData = wolfKillerGame.getGamerDataMap().get(reqMsg.getUserId());
...
//        WolfKillerGame wolfKillerGame = (WolfKillerGame) gameComponent
//                .getGameData(reqMsg.getGroup_id(), "狼人杀");
//        Werewolves werewolves = (Werewolves)wolfKillerGame.getOccupationMap().get(reqMsg.getUserId());
...
//     * @return
//     */
//    private boolean gamerIsInThisGame(Long groupId, String userId) {
//        if (!hasGameInGroup(groupId)) {
//            return false;
//        }
//        WolfKillerGame wolfKillerGame = (WolfKillerGame) gameComponent
...
//    }
//
//    private WolfKillerGamerData getGamerData(Long groupId, String userId) {
//        WolfKillerGame wolfKillerGame = (WolfKillerGame) gameComponent
//                .getGameData(groupId, "狼人杀");

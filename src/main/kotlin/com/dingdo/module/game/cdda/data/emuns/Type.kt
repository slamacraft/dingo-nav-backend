package com.dingdo.module.game.cdda.data.emuns

import com.dingdo.module.game.cdda.data.model.BodyPart
import com.dingdo.module.game.cdda.data.model.*
import com.dingdo.module.game.cdda.data.model.Generic
import com.dingdo.module.game.cdda.data.model.Monster
...
enum class Type(val typeName: String, val instanceSupplier: () -> BaseData) {
    ...
    ARMOR("ARMOR", { com.dingdo.module.game.cdda.data.model.Armor::class.createInstance() }),
